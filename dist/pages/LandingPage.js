...
export default function LandingPage() {
    ...
    return (React.createElement(ContentSection, null,
        React.createElement(Section, { className: "landing-page-primary" },
            ...
            React.createElement(ButtonPopupComponent, { id: "post-form-container", button_string: "Post your Project" }),
        ...
        React.createElement(Section, { className: "landing-page-primary-resources" },
            ...
            React.createElement("p", { className: "grey-color" }, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce at sapien eu ipsum ornare"),
        ...
        React.createElement(Section, { className: "landing-page-primary-customer" },
            ...
            React.createElement("div", { className: "flex" },
                ...
                React.createElement(ButtonPopupComponent, { id: "post-form-container", button_string: "Post your Project" }))),
        React.createElement(Section, { className: "landing-page-primary-resources" },
            React.createElement("h2", { className: "deep-blue-clrs" }, "Join the community of agencies"),
            React.createElement("p", { className: "grey-color" }, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce at sapien eu ipsum ornare"),
            React.createElement("div", { className: "card-container flex" },
        ...
        React.createElement(Section, { className: "landing-page-primary-customer" },
            ...
            React.createElement("div", { className: "flex" },
                ...
                React.createElement("span", null, "or"),
                React.createElement(ButtonPopupComponent, { id: "post-form-container", button_string: "Learn more" }))),
        React.createElement(Section, { className: "landing-page-primary-resources" },
            React.createElement("h2", { className: "deep-blue-clrs" }, "Our Resources"),
            React.createElement("p", { className: "grey-color" }, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce at sapien eu ipsum ornare"),
            React.createElement("div", { className: "card-container flex" },
